...
urlpatterns = [
    ...
    path('module/<int:module_id>/content/<module_name>/<id>/', views.ContentCreateUpdateView.as_view(),
    ...
    path('<slug:slug>/', views.CoursesDetailView.as_view(), name='course_detail'),
